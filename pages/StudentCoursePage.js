  ...
  return (
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <header className="mt-30 flex items-center justify-between px-6 py-4 bg-green-600 text-white">
        ...
        <div className="flex flex-1 justify-around items-center">
          ...
          <Link href="SubjectsPage">
            <FaBook className="text-2xl cursor-pointer" />
          </Link>
          ...
          <Link href="GamesPage">
            <IoGameController className="text-2xl cursor-pointer" />
          </Link>
          ...
          <Link href="StudentSubjectProgressPage">
            <IoReceiptOutline className="text-2xl cursor-pointer" />
          </Link>
        </div>
      </header>
      ...
      <div className="p-6 bg-gradient-to-r from-pink-500 to-red-400 text-white rounded-lg m-4">
        ...
        <p className="mt-2">
          It&apos;s time for your: {timetableActivity}
        </p>
      </div>
