...
export default function ParentsSubjectsDetailPageLit() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-orange-100 to-yellow-100 text-gray-800">
      {/* Header */}
     <div className="bg-orange-400 mt-35 text-white p-4 rounded-xl flex items-center justify-between">
      {/* Back Button */}
      ...
      <div className="flex justify-evenly items-center flex-1 gap-3">
        {[
          ...
          <button
            ...
            className="group flex flex-col items-center text-white hover:text-blue-400 transition"
          >
            {item.icon}
      ...
      <div className="px-4 py-6 text-center">
        <p className="text-lg mb-4">Hello parent of, @emailuser.com, I am Mrs Dlamini, your little star's Literature Teacher!</p>
        <div className="flex justify-center mb-4">
          <Image src="/teacher1.png" alt="Teacher" width={100} height={100} />
        </div>
        <p className="text-lg">This is where we will have all the Literature Fun!</p>
      </div>

      {/* Literature Activity */}
      <div className="mt-6 px-4 flex flex-col items-center">
        <div className="relative w-full max-w-md">
          <div className="absolute top-0 left-0 w-full h-24 bg-gradient-to-r from-orange-300 to-orange-500 z-10 rounded shadow-md flex items-center justify-center">
          <Image src="/book2.png" alt="Books" width={60} height={60} className="absolute right-6 bottom-5 z-20" />
            <p className="text-lg font-semibold text-white">Today we will do : "Cinderella"</p>
          </div>
      ...
      <div className="mt-36 px-4 flex flex-col items-center">
        <div className="relative w-full max-w-md">
          <div className="absolute top-0 left-0 w-full h-24 bg-gradient-to-r from-pink-300 to-pink-500 z-10 rounded shadow-md flex items-center justify-center">
          <Image src="/pencil.png" alt="Pencil" width={60} height={60} className="absolute right-6 bottom-5 z-20" />
            <p className="text-lg font-semibold text-white">Today's Literature Homework</p>
          </div>
      ...
      <div className="mt-36 flex justify-center">
        <div className="bg-yellow-100 p-4 rounded shadow-md w-full max-w-md text-center">
          <p className="text-lg font-bold mb-2">Week 1 Literature Homework</p>
          <p className="text-sm">Help your little ones with...</p>
          <p className="text-sm">Due: 02/01/2025, 5PM</p>
          <button
            onClick={handleSubmit}
            className={`mt-3 px-4 py-2 rounded text-white ${isSubmitted ? 'bg-green-500' : 'bg-blue-500'}`}
          >
      ...
      <div className="mt-10 px-4 flex flex-col items-center">
        <div className="relative w-full max-w-md">
          <div className="absolute top-0 left-0 w-full h-24 bg-gradient-to-r from-blue-300 to-blue-500 z-10 rounded shadow-md flex items-center justify-center">
          ...
          <tbody>
            {["Monday", "Tuesday", "Wednesday", "Thursday", "Friday"].map((day) => (
              <tr key={day} className="odd:bg-white even:bg-gray-100">
                ...
                {["Literature", "Life Skills", "Language", "Literature", "Life Skills"].map((subj, idx) => (
